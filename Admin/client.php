...
<link rel="stylesheet" type="text/css" href="layout/css/client.css">
...
?>
 ...
 <h1 class="text-center page-title">Manage client</h1>
...
<div class="search">
            ...
            <form method="POST">
                ...
                <label form="search">Search for client</label>
                <div class="row">
                    <div class="col-md-8">
...
$stmt = $con->prepare(" SELECT * FROM user WHERE type='client'");
$stmt->execute();
$rows = $stmt->fetchAll();
...
if($_FILES['image']['size'] !=0){
    ...
    move_uploaded_file($img_tmpName,'uploads/client/'.$tmpName);


    $stmt = $con->prepare("UPDATE `user` 
    SET `first name`='$Fname',`last name`='$Lname',`email`='$email' ,`password`='$pass' ,  
    `image`='$tmpName'
     WHERE  `ID`=$ID");
    $stmt->execute();
    ...
    <div class="row">
        ...
        <div class="col-md-6">
         ...
         <li><strong>Request sent:</strong><?php
          ...
          ?></li>
         <li><strong>Request received :</strong><?php  ?></li>
...
<script type="text/javascript" src="layout/js/client.js"></script>
